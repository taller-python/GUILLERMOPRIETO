...
@app.route('/actualizar_empleado/<cedula>', methods=['GET', 'PUSH'])
def actualizar_empleado(cedula):
    Actualizar_Empleado = Actualizar(cedula)
    print(Actualizar_Empleado.actualizado(cedula))


    if request.method == 'GET':
        return 'Hola desde Servidor  -  empleado actualizado  -  cedula:  %s'  % cedula
